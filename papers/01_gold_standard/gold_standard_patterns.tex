...
MobilityData canonical catalogue and observe that 166 systems
across 47 countries trigger at least one anomaly class, with two
candidate classes emerging from the global audit: A6 (zero-capacity
dock) flags 14 non-French systems, and A7 (null capacity field)
catches an additional 215 systems and 70{,}176 stations that the
v1.0 taxonomy A1--A5 was structurally blind to. The Czech
...
\begin{highlights}
\item Audit of 1{,}377 GBFS systems across 47 countries flags 188 systems
\item One operator drives each country: nextbike in Czechia, Pony in France
\item Two candidate classes (A6, A7) emerge from cross-country extension

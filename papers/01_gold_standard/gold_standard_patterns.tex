...
84.7\,\% of the certified rows; a positive control on Beryl London
(UK) shows that the documented errors are not inherent to GBFS but
are propagated by the absence of an audit tier. We further publish
three internal robustness checks, a cross-country pilot on three
non-French dock-based systems (Bicing Barcelona, Oslo Bysykkel,
Bergen Bysykkel; all three pass with zero anomalies), a
reproducibility checklist with container-pinned bit-exact replay,
and a six-experiment falsification roadmap with four pilots already
completed. The protocol is designed to

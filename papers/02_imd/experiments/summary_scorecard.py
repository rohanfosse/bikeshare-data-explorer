...
EXPERIMENTS = [
    ...
    ("E1", "Calibration",
     ...
     r"$\rho_{\mathrm{LOO}}$", 0.52, 0.30, "pass"),
    ("E2", "Calibration",
     "Weight-space LOO bootstrap",
     "Top-10 retention", 0.90, 0.50, "pass"),
    ("E3", "Construct",
     "Behavioural vs eco-counters",
     r"Partial $R^2$ net size", 0.24, 0.10, "pass"),
    ("E4", "Construct",
     "Exposure-adjusted safety",
     r"$\rho_S$ shift (raw $\to$ adj.)", 0.92, 0.50, "qualified"),
    ("E5", "Geometry",
     "Within-city station bootstrap",
     r"Kendall $\tau$ (median)", 0.85, 0.70, "pass"),
    ("E6", "Equity",
     "IES specification sweep",
     r"Robust deserts P$\geq$0.75", 0.83, 0.50, "pass"),
    ("E7", "Geometry",
     "Sobol/Jansen variance decomposition",
     r"$\sum_k S_k$ (score)", 0.98, 0.80, "pass"),
    ("E8", "Panel",
     "Spatial autocorrelation",
     r"$|$Moran $I|$", 0.025, 0.10, "pass"),
    ("E9", "Equity",
     "Bayesian IES posterior",
     r"$P(\beta_{\mathrm{velo}} > 0)$", 1.00, 0.95, "pass"),
    ("E10", "Panel",
     "Per-city IMD bootstrap CI",
     "Top-3 CI-distinct", 1.00, 0.80, "pass"),
    ("E11", "Geometry",
     "Parametric buffer-radius sweep",
     r"min Kendall $\tau$ (150-500m)", 0.92, 0.70, "pass"),
    ("E12", "Panel",
     "Cook-style leverage",
     r"max $|\Delta\bar\rho|$", 0.075, 0.10, "qualified"),
    ("E13", "Panel",
     "k-means typology",
     r"Silhouette ($k=4$)", 0.30, 0.20, "pass"),
]
